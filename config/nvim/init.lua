...
require("plugin-configs.nvim-comment") -- easily comment/uncomment lines of code
require("plugin-configs.gitsigns") -- show git diff signs in status column
...
require("plugin-configs.nvim-notify") -- better notifications
...
-- require("plugin-configs.mini-animate") -- animations
require("plugin-configs.mini-indentscope") -- animations
...
require("plugin-configs.true-zen") -- focus mode
