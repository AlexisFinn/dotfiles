...
local chalk_base = hsl(200, 20, 85)
local chalk_foam = hsl(200, 20, 40)
local chalk_teal = hsl(189, 30, 60)
local chalk_purple = hsl(240, 40, 75)
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    --
    TelescopeNormal { fg = chalk_base.darken(20) },
    TelescopeSelection { bg = chalk_board.lighten(5), fg = chalk_base, gui = 'italic' }, -- Currently selected item in Telescope.
    ...
    Function       { fg = chalk_teal }, --   Function name (also: methods for classes)
    ...
    -- Operator       { }, --   "sizeof", "+", "*", etc.
    Keyword         { fg = chalk_teal, gui = "italic" }, --   any other keyword
    ...
    sym"@variable"                    { fg = chalk_green }, -- Identifier
