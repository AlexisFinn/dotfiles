return {
            ...
            filetype = {
                ...
                javascript = {
                    function()
                        ...
                        if vim.fn.filereadable(".prettierrc.js") == 1 or
                            vim.fn.filereadable(".prettierrc") == 1 then
                            return {
                                exe = "prettier",
                            ...
                            return {
                                ...
                                args = {
                                    "--parser babel",
                                    "--config /home/alexis/.prettierrc", "-w"
                                },
                                stdin = true
                            }
                        end
                ...
                go = {
                    function()
                        return {exe = "goimports-reviser", args = {"-format"}}
                    end, function()
    ...
    autocmd!
    autocmd BufWritePost *.js,*.mjs,*.rs,*.lua,*.php,*.go,*.scss,*.css,*.html,*.tsx,*.sql,*.zig,*.json FormatWrite
    augroup END
    ]], {output = true})
    end
}
