        ...
        require("telescope").setup {
            ...
            pickers = {
                ...
                colorscheme = {
                    ...
                    initial_mode = "normal",
                    enable_preview = true,
                    layout_config = {height = 0.8, preview_height = 0.7}
                },
                grep_string = {
                    theme = "dropdown",
                    border = true,
    ...
    keys = {
        {
            ...
            desc = "Search through registers with Telescope"
        }, {
            "<leader>fw",
            ...
            desc = "Search for a file within the project"
        }, {
            "<leader>rg",
