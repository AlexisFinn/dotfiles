local keys = {
    --  ── Visual Mode ─────────────────────────────────────────────────────
    {
        ...
        desc = "Grep current word or selection in project",
        mode = "v"
    ...
    },
    {
        "<leader>ga",
        "<cmd>!git add %<CR>",
        desc = "Add current file to git commit"
    ...
    {"<leader>|", "<cmd>vsplit<CR>", desc = "Split window vertically"}, {
        ...
        function()
            ...
            vim.fn.execute("normal! o" ..
                               string.format("console.trace(%s);", curWord))
        end,
